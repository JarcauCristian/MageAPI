...
@router.get('/pipeline/status_once')
...
@router.get("/pipeline/run/status")
...
@router.get("/pipeline/trigger/status")
...
@router.get('/pipeline/batch_status')
...
@router.get("/pipeline/description")
